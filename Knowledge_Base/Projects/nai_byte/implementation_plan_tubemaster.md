...
สร้าง Skill/Agent ใหม่ที่ถูกฝึกมาเพื่อกลไกalgorithm YouTube โดยเฉพาะ
...
- กำหนด SOP (Standard Operating Procedure) ให้เชี่ยวชาญด้าน:
  ...
  3. **Scriptwriting (Meet Arnold Style):** เขียนscriptแบบตลกร้าย พร้อมกำหนด Scene มุมกล้อง และ Prompt เจนภาพนายไบต์ในสถานการณ์ต่างๆ
  4. **SEO & Metadata:** เขียน Title, Tags, และ Description ที่เป็นมิตรกับalgorithm
...
### Automated Tests
- ทดลองป้อนหัวข้อข่าว IT ให้ TubeMaster แล้วดูว่าscriptที่ได้ออกมามีสไตล์กวนๆ แบบ Meet Arnold และมี Prompt ภาพของนายไบต์ครบถ้วนหรือไม่

### Manual Verification
- บอสอ่านscriptแรกจาก TubeMaster แล้วประเมินว่าสไตล์การเขียน ดึงดูดและพร้อมทำคลิปจริงหรือไม่
